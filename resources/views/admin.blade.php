                        ...
                        <table class="w-full border border-gray-300 text-left">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border p-2">{{ \Carbon\Carbon::parse($konsul->tanggal)->format('d M Y H:i') }}</td>
                                    ...
                                    <td class="border p-2 text-center">
                                        ...
                                        <div class="flex gap-2 justify-center">
                                            <form action="{{ route('konsultasi.verifikasi', [$konsul->id, 'status' => 'diterima']) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600 text-sm">
                                                    Terima
                                                </button>
                                            </form>
                                            <form action="{{ route('konsultasi.verifikasi', [$konsul->id, 'status' => 'ditolak']) }}" method="POST">
                                                @csrf
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        ...
                        <table class="w-full border border-gray-300 text-left">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="border p-4 text-center text-gray-500">Tidak ada user ditemukan</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
